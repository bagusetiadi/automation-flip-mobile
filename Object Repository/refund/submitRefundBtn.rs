...
<MobileElementEntity>
   ...
   <webElementProperties>
      ...
      <name>text</name>
      <type>Main</type>
      <value> BUAT PERMINTAAN REFUND </value>
   </webElementProperties>
   <webElementProperties>
      <isSelected>true</isSelected>
      <matchCondition>equals</matchCondition>
   ...
   <locator>new UiSelector().className(&quot;android.widget.TextView&quot;).text(&quot; BUAT PERMINTAAN REFUND &quot;).packageName(&quot;id.flip&quot;).enabled(true).clickable(false).longClickable(false).checkable(false).checked(false).focusable(false).focused(false).scrollable(false).selected(false).index(0)</locator>
